...
var MODULES_DATA = {
    ...
    'module-18': {
        ...
        'category': 'Non-Technical',
        'Description': '<p>Painting competitions have long held an important place in the art world. Through these contests, you are able to display your work among your peers, have it reviewed by esteemed judges and secure important exposure. PiON’19 gives you a chance to display your artistic skills; as painting is a skill that can be mastered by anyone because it is not dependent on talent. In this competition, teams will be given a theme, based upon which they will have to paint on the provided canvas.</p><ul><li>Participants will be provided with acrylic paints, brushes, a single canvas per team (size A2), and other necessary supplies.</li><li>Time to complete the painting will be 2 hours, with the theme being announced 15 minutes before the starting time.</li><li>Participants are not allowed to bring any painting supplies with them, everything will be provided by the organisers. </li><li>Use of internet after the announcement of the theme till the finish time is forbidden.</li><li>Any misbehaviour with the other participants can result in penalty or elimination.</li><li>Communication and discussion of ideas is only allowed with your teammates during the competition.</li><li>Rules are prone to change.</li><li>Team which fails to follow any of the above rules can face penalty or possible disqualification.</li></ul>',
        // 'rules': []
    },
    'module-19': {
        'Image Name': '5.jpg',
